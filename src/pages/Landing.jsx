...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'מרגע שאתם משאירים פרטים ועד לקבלת מפתח, בדרך כלל 3 עד 6 חודשים, תלוי בנכס ובמכרז הספציפי. אנחנו לצידכם לאורך כל הדרך, ללא הפתעות.',
  },
  {
    q: 'מה אני משלם, ולמי?',
    a: 'השירות שלנו ניתן בעמלת הצלחה. תשלום רק אם עברנו את ההליך בהצלחה וקיבלתם את המפתח. אנחנו שקופים לחלוטין לגבי כל עלות בתהליך (אגרות, שמאות, עו"ד), בלי הפתעות.',
  },
  {
  ...
  },
  {
    ...
    a: 'מעבר להסכם ההתקשרות הברור שאתם מקבלים מראש, אנחנו עובדים גם עם עו"ד חיצוני שמייצג אתכם, לא אותנו. השקיפות שלנו היא הדבר שמבדיל אותנו.',
  },
];
