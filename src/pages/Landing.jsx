...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'מרגע שאתם משאירים פרטים ועד לקבלת מפתח, בדרך כלל 3 עד 6 חודשים, תלוי בנכס ובמכרז הספציפי. אנחנו מלווים אתכם לאורך כל הדרך, ללא הפתעות.',
  },
  {
    q: 'מה אני משלם, ולמי?',
    a: 'הליווי שלנו ניתן בעמלת הצלחה. תשלום רק אם עברנו את ההליך בהצלחה וקיבלתם את המפתח. אנחנו שקופים לחלוטין לגבי כל עלות בתהליך (אגרות, שמאות, עו"ד), בלי הפתעות.',
  },
  {
    q: 'מה אם בסוף לא אבחר לרכוש?',
    a: 'אתם לא מחויבים לכלום. שיחת הייעוץ הראשונית ללא עלות, וגם בהמשך אתם חופשיים לסגת בכל שלב לפני הגשת המכרז. ההחלטה תמיד שלכם.',
  },
  {
    q: 'איך אני יודע שאני לא קונה "חתול בשק"?',
    a: 'מעבר לחוזה הליווי הברור שאתם מקבלים מראש, אנחנו עובדים גם עם עו"ד חיצוני שמייצג אתכם, לא אותנו. השקיפות שלנו היא הדבר שמבדיל אותנו.',
  },
];
        ...
        <div className="landing-hero-inner">
          <div className="landing-hero-content">
            ...
            <p className="landing-hero-sub">
              ...
              <br />
              <strong>אצלנו תקבלו ליווי מלא מהבדיקה ועד למפתח, בלי הפתעות.</strong>
            </p>
        ...
        <div className="landing-container">
          ...
          <div className="landing-value-grid">
            ...
            <ValueCard
              ...
              desc='עורך דין שמלווה אתכם מבדיקת הנכס, דרך הגשת ההצעה, ועד לרישום הבעלות. בלי שיגעון בירוקרטי לבד. ההתקשרות עם עורך הדין היא ישירות בין הלקוח לעורך הדין.'
            />
            <ValueCard
              icon="🛡️"
              title="שקיפות מלאה"
        ...
        <div className="landing-container">
          ...
          <div className="landing-process-grid">
            ...
            <ProcessCard
              ...
              desc="הגשת הצעה, ניצחון במכרז, חתימה, רישום. אנחנו לצידך בכל שלב, בלי הפתעות ולא לבד. בנוסף, אנחנו מאפשרים לך אפשרות הכרוכה בתשלום לייעוץ עם שמאי מקרקעין מקצועיים."
            />
          </div>
        </div>
      </section>
