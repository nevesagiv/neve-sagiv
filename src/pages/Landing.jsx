...
const TRANSLATIONS = {
  he: {
    whatsappMsg: 'היי, הגעתי דרך אתר נווה שגיב. אני מעוניין בנכס במחיר נמוך',
    brandName: 'נווה שגיב',
  ...
  ru: {
    whatsappMsg: 'Привет, я пришел из сайта Neve Sagiv. Я заинтересован в недвижимости по низкой цене',
