...
const FAQ_ITEMS = [
  {
    q: 'מה זה בעצם נכס בכינוס נכסים?',
    a: 'נכס שבעליו לא עמדו בתשלומים (משכנתא, חוב לבנק או לרשות), ולכן בית המשפט מינה כונס נכסים שמוכר את הנכס במכרז. רוב הנכסים יוצאים במחיר נמוך משמעותית משווי השוק — אבל הליך המכרז מורכב ודורש הכנה.',
  },
  {
    q: 'איך אני מבטיח שלא אקנה "חתול בשק"?',
    a: 'בדיוק בשביל זה אנחנו כאן. אנחנו מבצעים בדיקת נכס מקיפה לפני הגשת ההצעה — סטטוס משפטי, חובות, שעבודים, מצב פיזי של הנכס וכל מה שצריך לדעת. אתה מקבל תמונה מלאה לפני שאתה מתחייב.',
  },
  {
  ...
  {
    q: 'איך אני יודע שלא תיקחו אותי בעלות סמויה?',
...
export default function Landing() {
  ...
  return (
    <div className="landing-page" dir="rtl">
        ...
        <div className="landing-hero-inner">
          <div className="landing-hero-content">
            ...
            <h1 className="landing-hero-title">
              נכסים בכינוס במחיר נמוך מהשוק
              <span className="landing-hero-em">— עם ליווי משפטי מקצועי</span>
            </h1>
            <p className="landing-hero-sub">
              לרוב הציבור אין גישה לעולם של כינוסי הנכסים — מורכבות משפטית, חוסר וודאות, וסיכון לטעויות יקרות.
              <br />
          ...
          >
            ...
            {status === 'success' ? (
              <div className="landing-form-success">
                ...
                <p>שלמה יחזור אליך תוך 24 שעות עם רשימת הנכסים הרלוונטיים אליך.</p>
        ...
        <div className="landing-container">
          ...
          <div className="landing-value-grid">
            <ValueCard
              ...
              desc="בכינוסי נכסים, נכסים יוצאים לעיתים קרובות 20-40% מתחת לשווי שוק. תפקידנו לזהות איזה נכס באמת שווה את ההצעה."
            />
            <ValueCard
              icon="⚖️"
              title="ליווי משפטי מלא"
              desc="עורך דין שמלווה אותך מבדיקת הנכס, דרך הגשת ההצעה, ועד לרישום הבעלות. בלי שיגעון בירוקרטי לבד."
            />
            <ValueCard
              icon="🛡️"
              title="שקיפות מלאה"
      ...
      >
        <div className="landing-container">
          <h2 className="landing-section-title landing-section-title-light">איך זה עובד — 3 צעדים פשוטים</h2>
          <div className="landing-process-grid">
            ...
            <ProcessCard
              ...
              desc="לפי התקציב והאזור שלך, אנחנו מסננים את כל הנכסים שזמינים בכינוס ומציגים לך רק את הרלוונטיים."
            />
            <ProcessCard
              n={3}
              title="ליווי A עד Z עד למפתח"
              desc="הגשת הצעה, ניצחון במכרז, חתימה, רישום — אנחנו לצידך בכל שלב. בלי הפתעות, בלי לבד."
            />
          </div>
        </div>
      </section>
        ...
        <div className="landing-container">
          ...
          <div className="landing-why-grid">
            <WhyCard
              ...
              desc={'לא סוכן נדל"ן רגיל — אנחנו מתמחים אך ורק בכינוסי נכסים. מכירים את הכונסים, את עורכי הדין, ואת מערכת המכרזים.'}
            />
            <WhyCard
              title="ליווי אישי"
              desc="כל לקוח מקבל ליווי אישי משלמה — לא צ'אט-בוט, לא נציג מתחלף. אדם אחד מהתחלה ועד הסוף."
            />
            <WhyCard
      ...
      >
        <div className="landing-container landing-container-narrow">
          ...
          <p className="landing-final-sub">
            השקעה בכינוסי נכסים יכולה להיות הצעד הכי חכם שתעשה השנה — אם תעשה אותו נכון.
            <br />
      ...
      <footer className="landing-footer">
        <div className="landing-container">
          <p>© נווה שגיב • ליווי השקעות בנכסי כינוס • <a href="/privacy">פרטיות</a> · <a href="/terms">תנאי שימוש</a></p>
        </div>
      </footer>
    </div>
  );
